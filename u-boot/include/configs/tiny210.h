...
#define CONFIG_SYS_PROMPT              "[tiny210-uboot]# "
...
#define CONFIG_SERVERIP		192.168.3.100
...
/*FIXED_byGmaui*/
#define CONFIG_BOOTARGS "root=/dev/mtdblock4 rootfstype=yaffs2 console=ttySAC0,115200 init=/linuxrc androidboot.console=ttySAC0 skipcali=yes ctp=2"
#define CONFIG_BOOTCOMMAND "tftp 0x21000000 uImage;bootm 0x21000000;"
#endif	/* __CONFIG_H */
